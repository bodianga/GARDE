...
case class Feature(id: String, branch: String, path: String, backgroundAsJson: Option[String] = None, tags: Seq[String], language: String, keyword: String, name: String, description: String, scenarios: Seq[ScenarioDefinition], comments: Seq[String] = Seq())
